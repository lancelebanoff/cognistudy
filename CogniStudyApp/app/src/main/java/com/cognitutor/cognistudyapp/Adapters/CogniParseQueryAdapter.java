 ...
 * </pre>
 */
public class CogniParseQueryAdapter<T extends ParseObject> extends BaseAdapter {
     ...
     */
//    public CogniParseQueryAdapter(Context context, Class<? extends ParseObject> clazz) {
...
//    }
     ...
     */
    public CogniParseQueryAdapter(Context context, final String className) {
...
//    }
     ...
     *        A resource id that represents the layout for an item in the AdapterView.
     */
    public CogniParseQueryAdapter(Context context, final String className, int itemViewResource) {
        this(context, new QueryFactory<T>() {
            @Override
            public ParseQuery<T> create() {
                ParseQuery<T> query = ParseQuery.getQuery(className);
     ...
     */
    public CogniParseQueryAdapter(Context context, QueryFactory<T> queryFactory) {
     ...
     *          A resource id that represents the layout for an item in the AdapterView.
     */
    public CogniParseQueryAdapter(Context context, QueryFactory<T> queryFactory, int itemViewResource) {
        this(context, queryFactory, Integer.valueOf(itemViewResource));
    }

    private CogniParseQueryAdapter(Context context, QueryFactory<T> queryFactory, Integer itemViewResource) {
        super();
    ...
    private void loadObjects(final int page, final boolean shouldClear, final Lock lock) {
        ...
        query.findInBackground(new FindCallback<T>() {
            ...
            public void done(List<T> foundObjects, ParseException e) {
                ...
                if (App.isLocalDatastoreEnabled ||
    ...
    protected void removeAllOnQueryLoadListeners() {
        this.onQueryLoadListeners.clear();
    }
}